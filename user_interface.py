...
class UserInterface:
    ...
    def droid_info_prompt(self):
        ...
        user_info_list.append(
            input(
                f"What type of droid do you want? (Enter digit as input)--\n"
                f"1 - Protocol: $150\n"
                f"2 - Utility: $100\n"
                f"3 - Janitor: $50\n"
                f"4 - Astromech: $200\n"
        ...
        user_info_list.append(
            f"What type of material do you want the droid to be made of?--\n"
            f"1 - Aluminum: $150\n"
            f"2 - Iron: $100\n"
            f"3 - Copper: $50\n"
            f"4 - Love: $200\n"
        ...
        user_info_list.append(
            f"What should the color of the droid be?--\n"
            f"1 - Gold: $150\n"
            f"2 - Silver: $100\n"
            f"3 - Bronze: $50\n"
            f"4 - Periwinkle: $200\n"
        ...
        user_info_list.append(
            f"Type the digit for the droid you want--"
            f"1 - Protocol: $150\n"
            f"2 - Utility: $100\n"
            f"3 - Janitor: $50\n"
            f"4 - Astromech: $200\n"
        ...
        user_info_list.append(
            f"How many languages do you want the droid to have?--"
            f"1 - $150\n"
            f"2 - $100\n"
            f"3 - $50\n"
            f"4 - $200\n"
